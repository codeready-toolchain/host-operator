...
ifeq ($(OPENSHIFT_BUILD_NAMESPACE),)
	...
	$(MAKE) -C ${E2E_REPO_PATH} test-e2e HOST_REPO_PATH=${PWD} HOST_IMAGE_NAME=default-route-openshift-image-registry.apps.build01.ci.devcluster.openshift.com/${OPENSHIFT_BUILD_NAMESPACE}/stable:host-operator
endif
