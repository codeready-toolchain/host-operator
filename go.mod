...
require (
	github.com/codeready-toolchain/api v0.0.0-20230222193913-dcab91c2e81f
...
replace (
	github.com/codeready-toolchain/api v0.0.0-20230222193913-dcab91c2e81f => github.com/ranakan19/api v0.0.0-20230303213346-27187fcb15d6
	github.com/codeready-toolchain/toolchain-common v0.0.0-20230217033022-295cba634c6d => github.com/ranakan19/toolchain-common v0.0.0-20230303213835-0e9f4459bbb7
)
