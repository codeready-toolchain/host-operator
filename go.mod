...
require (
	github.com/codeready-toolchain/api v0.0.0-20230804120829-047b143a4d4e
...
replace github.com/codeready-toolchain/api => github.com/mfrancisc/api v0.0.0-20230807232604-961eba2dbf4a
