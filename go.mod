...
require (
	...
	github.com/codeready-toolchain/toolchain-common v0.0.0-20221103204929-a8f82778def3
...
replace github.com/codeready-toolchain/api => github.com/mfrancisc/api v0.0.0-20221108133602-c5b3a69211db
