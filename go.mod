...
require (
	...
	github.com/codeready-toolchain/api v0.0.0-20190730071751-421041795a07
	github.com/codeready-toolchain/toolchain-common v0.0.0-20190807093245-e9da625513b0
