...
require (
	github.com/codeready-toolchain/api v0.0.0-20220201152329-6374e8bd52c9
...
replace github.com/codeready-toolchain/toolchain-common => github.com/rajivnathan/toolchain-common v0.0.0-20220209225636-a5690fadc03e
