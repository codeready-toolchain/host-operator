...
require (
	github.com/codeready-toolchain/api v0.0.0-20210412143528-2a936530ad35
...
replace (
	...
	github.com/codeready-toolchain/toolchain-common => github.com/ranakan19/toolchain-common v0.0.0-20210412135602-d447fcc27028
