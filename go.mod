...
require (
	github.com/codeready-toolchain/api v0.0.0-20220603031957-ebf902b425a9
...
replace github.com/codeready-toolchain/api => github.com/rajivnathan/api v0.0.0-20220603143545-b61349ffadd9
