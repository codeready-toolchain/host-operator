...
require (
	github.com/codeready-toolchain/api v0.0.0-20220628125054-39f4cbf8d344
...
replace github.com/codeready-toolchain/api => github.com/xcoulon/api v0.0.0-20220706152914-dd9f1e5d11bd
