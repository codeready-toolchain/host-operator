...
func TestGetNotificationTemplate(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		t.Run("get userdeactivated notification template", func(t *testing.T) {
			...
			assert.True(t, found)
			assert.Equal(t, "Notice: Your account is deactivated for Developer Sandbox for Red Hat OpenShift Beta", template.Subject)
		...
		t.Run("get userprovisioned notification template", func(t *testing.T) {
			...
			require.NotNil(t, template)
			assert.True(t, found)
			assert.Equal(t, "Notice: Your account is provisioned for Developer Sandbox for Red Hat OpenShift Beta", template.Subject)
		...
		t.Run("ensure cache is used", func(t *testing.T) {
			...
			assert.Equal(t, "Notice: Your account is provisioned for Developer Sandbox for Red Hat OpenShift Beta", template["userprovisioned"].Subject)
