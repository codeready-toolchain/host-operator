...
func GetConfig(cl client.Client, namespace string) (toolchainv1alpha1.HostOperatorConfigSpec, error) {
	config := configCache.get()
	if config == nil {
		err := loadLatest(cl, namespace)
		if err != nil {
			return toolchainv1alpha1.HostOperatorConfigSpec{}, err
		}
		config = configCache.get()
	}
	if config == nil {
		return toolchainv1alpha1.HostOperatorConfigSpec{}, nil
	}
