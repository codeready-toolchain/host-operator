...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileRegistrationService{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func (r *ReconcileRegistrationService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Fetch the RegistrationService instance
	instance := &toolchainv1alpha1.RegistrationService{}
