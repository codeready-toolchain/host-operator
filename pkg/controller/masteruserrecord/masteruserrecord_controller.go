...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileMasterUserRecord{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func (r *ReconcileMasterUserRecord) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set MasterUserRecord instance as the owner and controller
...
func newPodForCR(cr *toolchainv1alpha1.MasterUserRecord) *corev1.Pod {
