...
func TestAutomaticApprovalPredicateWhenApprovalIsEnabled(t *testing.T) {
	// given
	cl := test.NewFakeClient(t, NewToolchainConfigWithReset(t, testconfig.AutomaticApproval().Enabled()))
...
func TestAutomaticApprovalPredicateWhenApprovalIsNotEnabled(t *testing.T) {
	// given
	cl := test.NewFakeClient(t, NewToolchainConfigWithReset(t, testconfig.AutomaticApproval().Disabled()))
	predicate := OnlyWhenAutomaticApprovalIsEnabled{
		client: cl,
	}
	toolchainStatus := NewToolchainStatus()
