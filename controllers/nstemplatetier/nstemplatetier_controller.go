...
func (r *Reconciler) ensureTemplateUpdateRequest(logger logr.Logger, config commonconfig.ToolchainConfig, tier *toolchainv1alpha1.NSTemplateTier) (bool, error) {
...
func (r *Reconciler) activeTemplateUpdateRequests(logger logr.Logger, config commonconfig.ToolchainConfig, tier *toolchainv1alpha1.NSTemplateTier) (int, bool, error) {
